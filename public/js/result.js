...
async function load() {
  ...
  document.getElementById("resultIcon").textContent = level === "CRITICAL" ? "🚨" : level === "ELEVATED" ? "⚠️" : "✅";
  document.getElementById("resultTitle").textContent =
    level === "CRITICAL" ? "SESSION HIJACKING RISK" : level === "ELEVATED" ? "SESSION AT RISK" : "NO ACTIVE RISK";
